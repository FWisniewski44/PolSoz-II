...
### Gemeinsamkeit II: emotionaler Politikstil und Zuschnitt auf Parteiführung

+ Grigoriadis 2020, S. 12 (Fußnote 18)

+ Stavrakakis 2015

Auch bezüglich des Politikstils der beiden Parteien konnte eine gewisse Ähnlichkeit empirisch in den POPPA-Daten nachgewiesen werden. So 

### Gemeinsamkeit: Position zur EU ("Eurozone without austerity"), neue Konfliktlinie I

+ vgl. Mudde 2016, S. 26
+ vgl. Rori 2016, S. 1331

Ein weiterer Punkt, bei dem die Positionen der beiden Parteien sehr nah beieinander liegen und welcher darüber hinaus auch in der Forschung vielerorts als der *"Kleber"* der SYRIZA-ANEL-Koalition gesehen wurde, ist die Position beider Parteien in Bezug auf die EU.
...
+ Pappas, Takis (2015): *Populist Hegemony*, Open Democracy, Artikel vom 25.09., abgerufen unter: https://www.opendemocracy.net/en/can-europe-make-it/populist-hegemony-in-greece/ (Stand: 30.03.2021).
