...
abstract: "Hier sollte das Abstract stehen."
...
An dieser Stelle soll nun nochmals auf Abbildung 14 und die Implikationen für das griechische Parteiensystem verwiesen werden, die sich daraus ergeben. Neben der Überschneidung der beiden Parteien bei der EU-Position wird hier nochmals deutlich gemacht, dass es auch in der Spielart des Populismus, welcher bei beiden Parteien vorliegt, starke Überschneidungen gibt. Dies wurde auch in dieser Arbeit weiter herausgearbeitet, gerade in Bezug auf das manichäische Weltbild, die Rolle der Volkssouveränität und den Anti-Elitismus in beiden Parteien. Es sind also auch abseits der EU-Thematiken noch andere bindende Elemente vorhanden und hier wurde auch eine für Griechenland eine halbwegs stabile Zeit nach den Turbulenzen der Finanzkrise und den Folgeerscheinungen, wie den Umwälzungen im Parteiensystem, eingeläutet (vgl. Rori 2019, S. 1024).
Jedoch wurde zu Recht von der Forschung (vgl. Stavrakakis et al. 2017) darauf hingewiesen, dass dies eine stark instabile Partnerschaft ist und dass im Zweifel eher ein Verhalten eher nach ideologisch-politischen Positionen, als nach Überschneidungen bezüglich der Spielart des Populismus zu beobachten sein würde.

Dass dieses Schicksal auch die SYRIZA-ANEL-Koalition im Streit über das Prespa-Abkommen von 
