...
Nachdem diese grundlegende Frage zur Einordnung der SYRIZA-ANEL-Koalitionen von 2015 als ideologisch heterogene zweier populistischer Parteien geklärt wurde, soll sich nun zunächst mit der Frage nach den  verbindenden Faktoren auseinandergesetzt werden.

### Gemeinsamkeiten bei Aspekten des ideellen Ansatzes

Manichäisches Weltbild, Volkssouveränität, Antielitismus

### Gemeinsamkeit: emotionaler Politikstil

### Gemeinsamkeit: Position zur EU



## SYRIZA und ANEL: Was wirkte spaltend?
...
### Unterschiede bei Aspekten des ideellen Ansatzes

Homogenität und Volonté Générale

### Unterschiede in Parteienideologie

### Andere soziale und gesellschaftliche Vorstellungen
...
### Komplexität von Politik vs. Common Sense Politics

```{r complex, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
# complexity of decision making in politics vs. common sense politics
ggplot(data = poppa_GRC, aes(x = complex, y = party)) +
  geom_point() +
  theme_light() +
  geom_text(aes(label = party), hjust = 0.5, vjust = 1.5) +
  geom_point(data = poppa_SYRIZA_ANEL, aes(x = complex, y = party), colour = "red", size = 5) +
  labs(title = "SYRIZA und ANEL",
       subtitle = "Komplexe vs. Common Sense-Politik",
       caption = "Daten: POPPA 2019",
       tag = "Abbildung XY",
